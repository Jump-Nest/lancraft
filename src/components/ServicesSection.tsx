...
const services = [
  ...
  },
  {
    icon: FaTrophy,
    title: 'Ligy & turnaje',
    subtitle: 'Vytváříme soutěže, které zapojují hráče i fanoušky',
    description: 'Organizujeme e-sportovní ligy a turnaje od návrhu formátu až po finální realizaci. Zajistíme produkci, komunikaci, mediální podporu i zapojení partnerů do celého projektu.',
    features: [
      'Návrh a organizace lig a turnajů',
      'Komunikace a mediální podpora',
      'Zapojení partnerů',
      'Produkční zajištění',
    ],
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 font-montserrat max-w-3xl mx-auto">
            Herní marketing, influencer kampaně, eventy, ligy a turnaje přizpůsobené vašim cílům.
          </p>
        </motion.div>
