...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container: HTMLElement, targetElement?: HTMLElement) {
        this.container = container;
        this.targetElement = targetElement || container;
        ...
        this.targetElement.addEventListener('touchmove', this._onTouchMove, { passive: true });
        this.targetElement.addEventListener('mouseenter', this._onMouseEnter);
        this.targetElement.addEventListener('mouseleave', this._onMouseLeave);
        this.targetElement.addEventListener('touchend', this._onTouchEnd);
      }
      dispose() {
        ...
        t.removeEventListener('mouseenter', this._onMouseEnter);
        t.removeEventListener('mouseleave', this._onMouseLeave);
...
`;
    ...
    class WebGLManager implements LiquidEtherWebGL {
      ...
      constructor(props: any) {
        ...
        this.init();
        Mouse.init(props.$wrapper, Common.renderer!.domElement);
