        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-10">
          ...
          >
            ...
            <div className="space-y-6 text-gray-300 font-montserrat">
              ...
              <p className="text-sm sm:text-base leading-relaxed">
                Cookies jsou malé textové soubory, které webové stránky ukládají do vašeho zařízení 
                za účelem zlepšení uživatelského zážitku a poskytování personalizovaného obsahu.
              </p>
